...
public class TrackController {
    ...
    public ResponseEntity<?> getTrackByName(@PathVariable List<String> name){
        List<Track> getTrackByName = trackService.getAllTracks();
        return new ResponseEntity<>(getTrackByName,HttpStatus.OK);
    }
